...
public class RotationalCartesianTurtle extends CartesianTurtle {
  ...
  public RotationalCartesianTurtle move (double distance) {moveByDistance (distance); return this;}
  public RotationalCartesianTurtle jump (double distance) {jumpByDistance (distance); return this;}
}
