...
public class BasicTextRenderer {
  ...
  public TurtleCommand drawCharacter (char c) {
    switch (c) {
      ...
      case 'f': return seq (wind (8, 4), right (), jump (3), turn (90), jump (1), line (5), lateral (-5), turn (90), lateral (7));
      case 'g': return seq (jump (-2), turn (180), left (), wind (0, 4, 7, 4, 4, 5), jump (1), turn (-90));
      case 'h': return seq (topLeft (), line (9), jump (-5), turn (180), right (), wind (4, 5), turn (180), lateral (1));
      case 'i': return seq (turn (90), line (6), jump (-3), turn (-90), wind (0, 5, 1), lateral (-6), turn (90), lateral (5));
      case 'j': return seq (jump (-3), turn (90), wind (0, 2, 8), turn (-90), line (2), lateral (-6), turn (90), lateral (5));
      case 'k': return seq (line (6), jump (-3), turn (45), line (3 * diagonal), jump (-3 * diagonal), turn (90), line (3 * diagonal), turn (-135), lateral (3));
      case 'l': return seq (turn (90), line (6), jump (-3), turn (-90), wind (0, 8, 1), turn (90), jump (-9), lateral (6));
      ...
      case 't': return seq (lateral (3), line (6), turn (90), jump (-3), line (6), lateral (6), turn (-90), lateral (1));
      case 'u': return seq (jump (6), turn (180), wind (0, 5, 4, 5), jump (-6), lateral (1));
      case 'v': return seq (jump (6), turn (180), line (3), turn (-45), line (3 * diagonal), turn (-90), line (3 * diagonal), turn (-45), line (3), jump (-6), lateral (1));
      case 'w': return seq (jump (6), turn (180), wind (0, 5, 1, 5), turn (180), wind (0, 5, 1, 5), jump (-6), lateral (1));
      case 'x': return seq (turn (45), line (6 * diagonal), turn (-135), jump (6), turn (-135), line (6 * diagonal), turn (-135), lateral (1));
      case 'y': return seq (jump (6), turn (180), wind (0, 5, 5), turn (-90), jump (6), turn (180), wind (8, 5), turn (90), jump (3), lateral (7));
      case 'z': return seq (jump (6), turn (90), line (6), turn (135), line (6 * diagonal), turn (-135), line (6), turn (-90), lateral (1));
